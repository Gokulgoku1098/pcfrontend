  ...
  return (
    <>
      ...
      h-20 w-full bg-gradient-to-r from-black via-gray-900 via-yellow-500 via-pink-600 to-purple-900">
        <h1 className="text-3xl text-white">Select your storage</h1>
      </div>

      {product.map((storage, i) => (
        <div
          onClick={() => { handleNav(storage._id)}}
          key={i}
        ...
        >
          ...
          <div className="flex-1">
            <h1 className="font-semibold text-lg md:text-xl">{storage.name}</h1>
